...
![dict-copter-pitch-direction.gif](media/dict-copter-pitch-direction.gif)
...
### **FailSafe** - Фейлсейф
*опция аппаратуры радиоуправления, отключающая двигатели авиамодели при ### потере от передатчика.*
### **LOS** - Line of sight 
